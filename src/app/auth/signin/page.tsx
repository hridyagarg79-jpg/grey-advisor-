    ...
    <div className="min-h-[calc(100vh-3.5rem)] flex items-center justify-center px-4 py-16">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-stone-500 text-sm">Sign in to your Grey Advisor account</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <Link href="#" className="text-xs text-amber-700 hover:text-amber-800 font-medium">
                  Forgot?
                </Link>
              </div>
              <div className="relative">
        ...
        <p className="text-center mt-6 text-sm text-stone-500">
          ...
          <Link href="/auth/signup" className="text-amber-700 font-semibold hover:text-amber-800">
            Create one
          </Link>
        </p>
      </div>
